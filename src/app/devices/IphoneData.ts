import {IphoneInterface} from "./DevicesInterface";
export class IphoneData {



  iphone13ProMax: IphoneInterface = {
  ...
  iphone12ProMax: IphoneInterface = {
  ...
  iphone11ProMax: IphoneInterface = {
  ...
  iphoneXR: IphoneInterface = {
    deviceName: 'iPhone XR',
    deviceImg: 'assets/iphone/iphoneXR.png',
    repairId: 'IphoneXR',
    repair: [
      {repairTitle:'Screen:', repairDetails: '', repairImg: 'assets/iphone/brokenScreen.png',repairPrice: '$125.00'},
      {repairTitle:'Rear Screen:', repairImg: 'assets/iphone/rearCrack.png',repairPrice: '$85.00 - $95.00'},
  ...
  iphoneEtc: IphoneInterface = {
    deviceName: 'iPhone 6 Plus, iPhone 6, iPhone 5, etc',
    deviceImg: 'assets/iphone/iphone7.png',
    repairId: 'IphoneEtc',
    repair: [
      {repairTitle: 'Call/Text for pricing', repairImg: 'assets/iphone/electriciphone.png'},
    ]
  };

   getDevices(){
     let arr : Array<IphoneInterface> = [this.iphone13ProMax, this.iphone13Pro, this.iphone13, this.iphone13Mini, this.iphone12ProMax, this.iphone12Pro, this.iphone12, this.iphone12Mini, this.iphoneSE, this.iphone11Pro, this.iphone11, this.iphoneXSMax, this.iphoneXS, this.iphoneX, this.iphoneXR, this.iphone8Plus, this.iphone8, this.iphone7Plus, this.iphone7, this.iphoneEtc];
     return arr;
   }
